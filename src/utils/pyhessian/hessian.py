...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True, minibatch_mod=False):
        """
        ...
        if minibatch_mod:
            assert dataloader, "dataloader must be provided for minibatch_mod=True"
        ...
        self.minibatch_mod = minibatch_mod
    ...
    def dataloader_hv_product(self, v):
        ...
        for data_pkg in self.data:
            self.model.zero_grad()
            if self.minibatch_mod:
                tmp_num_data = data_pkg.sample_ids.shape[0]
                loss =  -self.criterion(data_pkg)
            else:
                inputs, targets = data_pkg
